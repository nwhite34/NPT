...
const MissionSection = ({ onButtonClick }) => {
  ...
  return (
    <div id="mission-section" className="bg-black text-white py-12 min-h-[100vh] mt-60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <animated.div style={animatedProps} className="text-center">
          ...
          <button onClick={onButtonClick} className="mt-20 bg-white text-black py-3 px-8 rounded-full font-bold transition duration-300 ease-in-out cursor-pointer text-xl md:text-2xl shadow-xl hover:bg-custom-gold hover:text-white mb-4 focus:outline-none focus:ring-2 focus:ring-custom-gold focus:ring-opacity-50">
