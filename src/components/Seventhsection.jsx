    ...
    <div className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mb-4">
            We're committed to helping over 1,000 people in Milton Keynes live longer, stronger, more confident lives. It's why we offer free trial sessions, and our iron-clad money back guarantee on results (yes, really)
          </p>
          <p className="mb-4">
