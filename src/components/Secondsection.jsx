...
// Tailwind CSS configuration adjustments might be necessary to define custom-gold
// For example, in tailwind.config.js you might add:
// theme: {
//   extend: {
//     colors: {
//       'custom-gold': '#DAA520', // This is a gold-like color; adjust as needed
//     },
//   },
// },
    ...
    <div className="bg-black py-12 text-white ">
        ...
        <div className="mt-1 bg-gray-900 rounded-md p-5">
          <div className="flex flex-wrap -mx-4 ">
            <div className="w-full md:w-1/2 px-4 mb-10 md:mb-0 ">
              <img src={nickJpg} alt="Description of the image" className="w-full max-w-xs rounded-lg shadow-lg" />
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8    ">
        ...
        <div className="mt-5 bg-gray-900 rounded-md p-5">
          <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 px-4 ">
              <img src={nick1Jpg} alt="Description of the image" className="w-full max-w-xs rounded-lg shadow-lg " />
            </div>
            <div className="w-full md:w-1/2 px-4">
              <div className="mb-6">
                <h3 className="text-lg leading-6 font-medium text-white">Small Group Personal Training</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8    ">
        ...
        <div className="mt-5 bg-gray-900 rounded-md p-5">
          <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 px-4 ">
              <img src={nick2Jpg} alt="Description of the image" className="w-full max-w-xs rounded-lg shadow-lg " />
            </div>
            <div className="w-full md:w-1/2 px-4">
              <div className="mb-6">
                <h3 className="text-lg leading-6 font-medium text-white">Small Group Personal Training</h3>
